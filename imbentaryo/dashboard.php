    ...
    <div class="container">
        ...
        <div class="container py-3 px-0">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <!--?php
              echo $_SESSION['loggedIn'] ? '<li><a href="logout.php" class="btn btn-primary">Logout</a></li>' : '';
              ?-->
      ...
      <div class="container-fluid">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="row">
            <div class="col-sm-6"  id="inv-summary">
              <!-- First column section -->
              <div class="panel panel-default">
                <div class="panel-body">Inventory Summary</div>
              </div>
            </div>
            <div class="col-sm-6"  id="inv-activity">
              <!-- Second column section -->
              <div class="panel panel-default">
                <div class="panel-body">Inventory Activity</div>
              </div>
            </div>
          </div>
          <div class="row"  id="inv-charts-graphs">
            <div class="col-sm-12">
              <!-- Full-width section -->
              <div class="panel panel-default">
                <div class="panel-body">Inventory Charts / Graphs</div>
              </div>
            </div>
          </div>

          <div class="row"  id="inv-reports">
            <div class="col-sm-12">
              <!-- Full-width section -->
              <div class="panel panel-default">
                <div class="panel-body">Inventory Reports</div>
              </div>
            </div>
          </div>
